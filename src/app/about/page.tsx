        ...
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-primary-100 text-lg">Supporting Community</div>
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-40 h-40 bg-gradient-to-br from-amber-300 to-orange-400 rounded-full mx-auto mb-4 flex items-center justify-center text-6xl">
                &#x1F469;&#x200D;&#x1F4BC;
              </div>
              <h3 className="text-xl font-bold text-secondary-900 mb-1">Sarah Chen</h3>
              <p className="text-primary-700 font-semibold mb-2">Founder & CEO</p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-secondary-900 mb-1">Michael Torres</h3>
              <p className="text-primary-700 font-semibold mb-2">Head of Technology</p>
              <p className="text-secondary-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-secondary-900 mb-1">Emma Rodriguez</h3>
              <p className="text-primary-700 font-semibold mb-2">Artisan Relations</p>
              <p className="text-secondary-600 text-sm">
